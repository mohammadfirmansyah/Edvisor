...
|
*/
// Mendapatkan hostname dari permintaan saat ini
...
|
*/
$config['encryption_key'] = 'MOHAMMADFIRMANSYAH';
...
|
*/
$config['sess_driver'] = 'database'; // Menggunakan driver sesi berbasis database
$config['sess_cookie_name'] = 'ci_session'; // Nama cookie sesi
...
// Menentukan apakah sesi akan berakhir saat browser ditutup
// Diatur di Controller berdasarkan "Remember Me"
